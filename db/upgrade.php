...
/**
 * This file keeps track of upgrades to the codiana module
 *
...
/**
 * Execute codiana upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_codiana_upgrade ($oldversion) {
    global $DB;
    ...
    // for demonstrative purposes and to show how the codiana
    // iself has been upgraded.

    // For each upgrade block, the file codiana/version.php
